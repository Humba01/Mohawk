...
import me.jellysquid.mods.sodium.client.world.cloned.palette.ClonedPaletteArray;
...
public class ClonedChunkSection {
    ...
    private static ClonedPalette<BlockState> copyPalette(PalettedContainerExtended<BlockState> container) {
        ...
        if (palette instanceof IdentityPalette) {
            return new ClonedPaletteFallback<>(GameData.getBlockStateIDMap());
        }
        ...
        return new ClonedPaletteArray<>(array, container.getDefaultValue());
    }
