...
/**
 * Generally provides better performance over the vanilla {@link net.minecraft.util.palette.HashMapPalette} when calling
 * {@link LithiumHashPalette#(Object)} through using a faster backing map and reducing pointer chasing.
 */
